...
func = ToolkitModel(name='ultralytics_image_classification', task='computer_vision', description='UltraLytics Image Classification Using YOLOv8 Classifier.', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/image_classification')
