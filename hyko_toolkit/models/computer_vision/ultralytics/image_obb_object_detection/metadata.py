...
func = ToolkitModel(name='ultralytics_image_obb_object_detection', task='computer_vision', description='UltraLytics Image Oriented Bounding Boxes Object Detection Using YOLO V8.', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/image_obb_object_detection')
