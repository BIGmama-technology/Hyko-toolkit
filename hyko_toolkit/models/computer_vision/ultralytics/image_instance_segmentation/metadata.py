...
func = ToolkitModel(name='ultralytics_image_instance_segmentation', task='computer_vision', description='UltraLytics Instance Segmentation Using YOLO segmentation V8.', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/image_instance_segmentation')
