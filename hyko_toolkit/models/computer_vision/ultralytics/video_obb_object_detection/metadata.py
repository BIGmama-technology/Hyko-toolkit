...
func = ToolkitModel(name='ultralytics_video_obb_object_detection', task='computer_vision', description='UltraLytics Video Oriented Bounding Boxes Object Detection Using YOLO V8.', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/computer_vision/ultralytics/video_obb_object_detection')
