...
func = ToolkitModel(name='summarization', task='natural_language_processing', description='Hugging Face summarization', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/natural_language_processing/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/natural_language_processing/summarization')
