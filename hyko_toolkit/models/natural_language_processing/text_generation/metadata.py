...
func = ToolkitModel(name='text_generation', task='natural_language_processing', description='Hugging Face text generation', absolute_dockerfile_path='./toolkit/hyko_toolkit/models/natural_language_processing/Dockerfile', docker_context='./toolkit/hyko_toolkit/models/natural_language_processing/text_generation')
