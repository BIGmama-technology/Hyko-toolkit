...
func = ToolkitFunction(
    ...
    docker_context="./toolkit/hyko_toolkit/functions/utils/image_utils/crop_edges",
)
...
class Params(CoreModel):
    top: PositiveInt = Field(
        default=0, description="Number of pixels to crop from the top"
    )
    left: PositiveInt = Field(
        default=0, description="Number of pixels to crop from the left"
    )
    right: PositiveInt = Field(
        default=0, description="Number of pixels to crop from the right"
    )
    bottom: PositiveInt = Field(
        default=0, description="Number of pixels to crop from the bottom"
    )
