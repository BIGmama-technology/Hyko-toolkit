...
func = ToolkitFunction(
    ...
    absolute_dockerfile_path="./toolkit/hyko_toolkit/functions/utils/text_utils/Dockerfile",
    docker_context="./toolkit/hyko_toolkit/functions/utils/text_utils/index_mapping",
)
