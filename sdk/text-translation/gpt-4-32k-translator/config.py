...
name = "gpt-4-32k-translator"
description = "OpenAI's GPT 4 Large Translation model (API)"
version = "1.0"
category = "OpenAi"
...
class Inputs(BaseModel):
    original_text: str = Field(..., description="The text to be translated (32k tokens max context size)")
