...
name = "text-davinci-003-translation"
description = "Translation Model (API)"
version = "1.0"
category = "OpenAi"
...
class Params(BaseModel):
    language: String = Field(default='French', description='Language to be translated to')
...
class Outputs(BaseModel):
    translated_text: String = Field(..., description="Translated text by GPT3")
