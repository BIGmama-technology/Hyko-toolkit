...
class Inputs(CoreModel):
    text : str = Field(..., description="English text input provided by the user for speech generation")
...
class Outputs(CoreModel):
    audio : Audio = Field(..., description="Generated audio containing the speech corresponding to the provided text")
