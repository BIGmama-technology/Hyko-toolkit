...
class Params(CoreModel):
    history_prompts : str = Field(..., description="History prompts for audio generation")
...
async def main(inputs: Inputs, params: Params)-> Outputs:
    audio_array = generate_audio(inputs.text, history_prompt=params.history_prompts, text_temp=params.text_tempreture, waveform_temp=params.waveform_temp)
