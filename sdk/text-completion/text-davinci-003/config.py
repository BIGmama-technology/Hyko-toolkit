...
class Params(BaseModel):
    ...
    max_tokens: Optional[Integer] = Field(..., description="maximum number of tokens generated by the LLM")
    temperature: Optional[Number] = Field(..., description="GPT3 temperature")
    top_p: Optional[Number] = Field(..., description="GPT3 Top P")
