...
description = "OpenAI's Text Davinci 003 completion model (API)"
version = "1.0"
category = "OpenAi"
...
class Params(BaseModel):
    system_prompt: Optional[str] = Field(default=None, description='System prompt for the model (added as a pre-prompt to the input prompt)')
